...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    ...
    <li role="presentation"@if($status == App\Order::ORDER_STATUS_CANCEL) class="active"@endif><a href="{{ route('staff.orders.index') }}?status={{ App\Order::ORDER_STATUS_CANCEL }}">キャンセル</a></li>
  </ul>
