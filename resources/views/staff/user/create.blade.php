    ...
    <div class="rg_inner">
      ...
      {!! Form::open(['route' => 'staff.user.store', 'method' => 'post', 'files' => true, 'class' => 'form-horizontal']) !!}
        <div class="form-group">
          <label for="email" class="control-label col-md-4">メールアドレス（※非公開）<span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="password" class="control-label col-md-4">パスワード <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">姓 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">名 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">画像 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">都道府県 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
            鳥取県
          </div>
        </div>
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">エリア <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">プロフィール <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">サービス名 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">カテゴリ <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">時給 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">最高時間 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">詳細な場所 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
        ...
        <div class="form-group">
          <label for="" class="control-label col-md-4">詳細説明 <span class="text-danger">必須</span></label>
          <div class="col-md-8">
