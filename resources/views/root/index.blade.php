...
@section('content')
  ...
  <div class="container clearfix m_u40">
    <div class="flow-box request">
      ...
      <!-- / .title -->
      <div class="description m_u20"> まずは「みんなのお父さん」に新規登録をしましょう。<strong>ニックネーム</strong>と<strong>メールアドレス</strong>だけで、カンタンに登録できます。登録だけなら一切費用はかかりません。</div>
      <!-- / .description -->
      <div class="link"><a href="{{ route('user.create') }}" class="button red">新規登録はこちら</a></div>
    </div>
    <!-- / .flow-box -->
    <div class="flow-box worker">
      <div class="title"><span class="number">01</span> ｢みんなのお父さん｣に登録する</div>
      <!-- / .title -->
      <div class="description m_u20">｢仕事をしたい方はこちら｣から 新規登録を行います。<strong>メールアドレス</strong>、<strong>ニックネーム</strong>、<strong>お住まいの都道府県</strong>、<strong>プロフィール</strong>などの必要情報を入力し、登録を行います。</div>
      <!-- / .description -->
      <div class="link"><a href="{{ route('staff.user.create') }}" class="button yellow">｢みんなのお父さん｣への登録はこちら</a></div>
    </div>
    <!-- / .flow-box -->
  </div>
  <!-- / .clearfix -->
  ...
  <div class="container clearfix m_u40">
    <div class="flow-box request">
      <div class="title"><span class="number">02</span> サービスを依頼する</div>
      <!-- / .title -->
    ...
    <!-- / .flow-box -->
    <div class="flow-box worker">
      <div class="title"><span class="number">02</span> 提供したいサービスを登録します</div>
      <!-- / .title -->
      <div class="description m_u20">スタッフ用画面から、提供したい<strong>サービス</strong>、<strong>希望時給</strong>、<strong>時間</strong>、対応可能エリア、サービスについての説明を登録します。</div>
      <!-- / .description -->
      <div class="link"><a href="{{ route('staff.root.index') }}" class="button yellow">サービスの登録はこちら</a></div>
    </div>
    <!-- / .flow-box -->
  </div>
  <!-- / .clearfix -->
  ...
  <div class="container clearfix m_u40">
    <div class="flow-box request">
      <div class="title"><span class="number">03</span> 依頼したサービスの返信を待つ</div>
      <!-- / .title -->
    ...
    <!-- / .flow-box -->
    <div class="flow-box worker">
      <div class="title"><span class="number">03</span> 依頼されたサービスに返信する</div>
      <!-- / .title -->
  ...
  <div class="container clearfix m_u40">
    <div class="flow-box request">
      <div class="title"><span class="number">04</span> サービスを受けます</div>
      <!-- / .title -->
    ...
    <!-- / .flow-box -->
    <div class="flow-box worker">
      <div class="title"><span class="number">04</span> サービスを提供します</div>
      <!-- / .title -->
